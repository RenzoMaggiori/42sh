...
*/
    ...
    #define BIN_NOT_EXEC                    ". Wrong Architecture.\n"
    #define NO_ERROR                        0
    #define SIG_AMT                         4
    #define HAS_ERROR                       1
    #define NONE                            0
